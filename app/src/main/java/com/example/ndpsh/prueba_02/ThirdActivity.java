...
public class ThirdActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgBtnCam = (ImageButton) findViewById(R.id.imageButtonCam);
            ...
            public void onClick(View view) {
                ...
                if (phoneNumber != null && !phoneNumber.isEmpty()) {
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                        ...
                        // Comprobar si ha aceptado, no ha aceptado o nunca se le a preguntado
        ...
        //esto es el boton para el link web
        imgBtnWeb.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String url = editTextWeb.getText().toString();
                String email = "pepito1234@gmail.com";
                ...
                if (url != null && !url.isEmpty()) {
                    ...
                    intentMail.putExtra(Intent.EXTRA_EMAIL, new String[]{"ferna123@gmail.com", "antony123@gmail.com"});
                    //startActivity(Intent.createChooser(intentMail, "Elige una app de correo"));

                    //Telefono 2, sin permisos requeridos
                    Intent intentPhone = new Intent(Intent.ACTION_DIAL, Uri.parse("tel:666333111"));
        ...
        switch (requestCode) {
            case PHONE_CALL_CODE:
                ...
                if (permission.equals(Manifest.permission.CALL_PHONE)) {
                    ...
                    //Comprobar si ha sido aceptado o denegado la peticcion de permiso
